...
- (void) testBase64EncodedStringWithOptions
{
    NSString *input = @"!@#$%^&*()<>?:{}";
    NSString *output = [input base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength];
    XCTAssertEqualObjects(output, @"IUAjJCVeJiooKTw+Pzp7fQ==");
}

- (void) testBase64EncodedDataWithOptions
{
    NSString *input = @"!@#$%^&*()<>?:{}";
    NSData *output = [input base64EncodedDataWithOptions:NSDataBase64Encoding64CharacterLineLength];
    XCTAssertEqualObjects([[NSString alloc] initWithData:output encoding:NSUTF8StringEncoding], @"IUAjJCVeJiooKTw+Pzp7fQ==");
}
